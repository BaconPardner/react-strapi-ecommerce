...
export const handleLogo = (brandName: string) => {
  for (const { name, logo } of logoList) {
    if (name === brandName) return logo;
  }

  return <p className="py-3 text-sm">Unknown</p>;
};
